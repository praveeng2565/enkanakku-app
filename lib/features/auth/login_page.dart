...
class _LoginPageState extends State<LoginPage>
  ...
  // Continuously increasing animation time.
  //
  // This is deliberately NOT reset when AnimationController
  // completes.
  ...
  void initState() {
    ...
    // The controller is only used as a frame ticker.
    //
    // We DON'T use controller.value for positioning the bubbles.
      ...
      body: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          if (_lastFrameTime != null) {
            ...
            // Keep the speed independent of frame rate.
            _bubbleTime += elapsed;
          }
